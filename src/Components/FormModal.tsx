...
export default function FormModal({isModalOpen, setIsModalOpen}:Props) {
    ...
    const [restImpact, setRestImpact] = useState<number>(30);
            ...
            <ModalBody>
                <Form>
                    <FormGroup>
                        ...
                        <Ranger id="codeImpact" range={codeImpact} setRange={setCodeImpact}/>
                        <hr/>
                        ...
                        <Ranger range={meetImpact} setRange={setMeetImpact} id="meetImpact" />
                        <hr/>
                        ...
                        <Ranger range={restImpact} setRange={setRestImpact} id="restImpact"/>
                        <hr/>
                        ...
                        <Label for="restPercentage">
                            ...
                            Qual a porcentagem das horas livres que você tem, que você considera saudável para você descansar?
                        </Label>
                        <Ranger 
                ...
                <Row>
                    ...
                    <Col className="mt-3 mb-3" xl="2">
                        <Button block disabled={weekHoursInvalid} color="success">
                            Pronto!
                        </Button>
                    </Col>
                    <Col className="mt-3 mb-3" xl="2">
